...
- [social-multiplication] When I write the code, I have to consider the unit test. The good method is to do TDD. If you make the test code before you write the business code, This order makes you consider to wirte the business code for unit test.
